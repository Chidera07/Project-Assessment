			...
			<div class="col-10 makeGray ">
				<div style="padding-bottom: 2%" class="row paddingTop giveMargin2">
					...
					<div class="col-9">
						...
						<a  href=""><img style="width: 3%; padding:2px padding-left:10px" class="float-right" src="img/user.svg" alt="msgimage"></a>
						<a  href=""><img style="width: 3% ; padding: 2px; margin:0" class="float-right" src="img/bdashboard.svg" alt="iconimage"></a>
